...
export default function ItemsPage() {
    ...
    useEffect(() => {
        ...
        // Fire both silently — no loading state blocks the page
        fetchItems();
        fetchPlaces();
    }, [user, authLoading]);
    ...
    // Blank dark screen while auth resolves — no flash, no spinner
        ...
        <>
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .add-btn {
                    ...
                    box-shadow: 0 6px 20px rgba(99,102,241,0.35); transition: all 0.2s;
                ...
                .code-badge {
                    ...
                    font-family: monospace; border: 1px solid rgba(99,102,241,0.18);
                }
            ...
            <div className="page-root">
                ...
                <main className="main-content fade-in">
                    ...
                    {/* Status chips — update silently as data loads */}
                    ...
                    {/* Table — renders immediately, rows appear as data loads */}
                        ...
                        <div className="form-fields">
                            {[
                                ...
                                <div key={f.field}>
                                    ...
                                    <input
                                        type={f.type} value={form[f.field]} placeholder={f.ph}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="field-input-m" style={{ padding: '8px 13px' }}
                                    onChange={e => { if (e.target.files && e.target.files[0]) setImageFile(e.target.files[0]); }}
                                />
                                {imageFile && <p style={{ color: '#4ade80', fontSize: '12px', marginTop: '4px' }}>✓ {imageFile.name}</p>}
                                {editItem?.image && !imageFile && (
                                    <div style={{ marginTop: '8px' }}>
                                        <img src={`${baseUrl}/storage/${editItem.image}`} alt="current" style={{ width: '56px', height: '56px', borderRadius: '8px', objectFit: 'cover', border: '1px solid rgba(255,255,255,0.1)' }} />
                                        <p style={{ color: '#64748b', fontSize: '11px', marginTop: '4px' }}>Current image kept if none selected</p>
                                    </div>
                                )}
                            </div>
                            <div>

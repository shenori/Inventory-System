...
export default function BorrowingsPage() {
    ...
    const fetchAll = async () => {
        try {
            ...
            localStorage.setItem('cache_borrowings', JSON.stringify(b.data)); // ✅ cache borrowings
            setItems(i.data.filter((item) => item.quantity > 0));
            localStorage.setItem('cache_items', JSON.stringify(i.data)); // ✅ cache items
        ...
        <>
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .submit-btn-m { flex: 1; padding: 12px; background: linear-gradient(135deg, #f59e0b, #d97706); color: white; border: none; border-radius: 10px; font-size: 13px; font-weight: 700; cursor: pointer; font-family: inherit; box-shadow: 0 6px 20px rgba(245,158,11,0.3); transition: all 0.2s; }
            ...
            <div className="page-root">
                ...
                <main className="main-content fade-in">
                    <div className="page-header">
                        ...
                        <button className="add-btn" onClick={() => { setShowModal(true); setError(''); }}>➕ New Borrowing</button>
                    </div>
                    ...
                    <div className="table-wrap">
                        <table>
                            ...
                            <tbody>
                                {filtered.length === 0 ? (
                                    <tr><td colSpan={8}><div className="empty-state"><div className="empty-icon">📭</div><p>{search ? 'No results found' : 'No borrowings recorded yet'}</p></div></td></tr>
                                ) : filtered.map(b => {
